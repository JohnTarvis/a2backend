...
--   id INT NOT NULL PRIMARY KEY, --available for 1 year + 1 year after account deletion
--   ip INT NOT NULL, --private and kept to monitor illegal activity
--   birth_time DATE, --account created
--   handle VARCHAR(31), --public and available for as long after deletion as account has existed UNIQUE
--   is_admin BOOLEAN NOT NULL DEFAULT FALSE, 
--   password TEXT NOT NULL


-- INSERT INTO anons (handle,ip,password,is_admin)
-- VALUES ('testuser',
--         '192.168.1.254',
--         'password',
--         FALSE),
